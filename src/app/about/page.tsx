...
export default function AlertDialogDemo() {
  ...
  <div className="flex flex-col md:flex-row justify-between gap-6 px-2 sm:px-4">
    ...
    <div className="left w-full md:w-[50%] space-y-4">
      <h1 className="text-2xl md:text-3xl text-[#4595eb] font-bold">About Me</h1>
      <p className="text-sm md:text-base leading-relaxed">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum,
        tenetur ad qui debitis ut sunt voluptates sit soluta eaque? Harum non,
    ...
    <div className="flex justify-center items-center w-full md:w-[50%]">
      <Image src="/coder.svg" width={300} height={300} alt="aboutImage" className="w-full max-w-[250px] md:max-w-[400px]" />
    </div>
  </div>

  {/* Skills */}
  <div className="px-2 sm:px-4 sm:mt-6">
    <h1 className="text-2xl md:text-3xl text-[#4595eb] font-bold">Skills</h1>
    <TooltipDemo />
  </div>
</AlertDialogContent>
